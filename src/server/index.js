...
const fs = require('fs');
const {authorizeCap, dateOfRegistration,registrationPrincipalBusiness,registrationIndustrialClass}=require('./problem');
...
fs.createReadStream('../Data/Maharastra.csv')
    ...
    .on('end', () => {
        ...
        dumpData(registrationPBA,'../Output/resgistration_Principal_Business.json');  
